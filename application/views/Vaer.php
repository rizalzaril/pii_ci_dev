<div class="container mt-3">
  ...
  <!-- TABLE AER SECTION -->
  <table id="table_aer" class="table table-sm table-striped">
    <thead>
      <tr class="center">
...
<script>
  $(document).ready(function() {
    let table = $('#table_aer').DataTable({
      processing: true,
      serverSide: true,
      ajax: {
        url: "<?= base_url('Aer/get_aer') ?>",
        type: "GET",
        data: function(d) {
