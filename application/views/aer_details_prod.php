                        ...
                        <div class="col-md-8">
                          <label class="control-label">
                            ...
                            <?php if ($this->session->userdata('type') == "0" || $this->session->userdata('type') == "2" || $this->session->userdata('type') == "9" || $this->session->userdata('type') == "14" || $this->session->userdata('type') == "13" || ($this->session->userdata('type') == "11" && $this->session->userdata('code_wilayah') == "" && $this->session->userdata('code_bk_hkk') == "")) {
                              echo ($row->id_file != '') ? $row->idcard . ' <a target="_blank" href="' . base_url() . 'assets/uploads/' . $row->id_file . '"> Download </a>' : $row->idcard;
                            } else {
                ...
                <table class="table" style="margin-left:5px;">
                  ...
                  ?>
                    ...
                    <tr class="row">
                      ...
                      <td><label class="control-label"><?php if ($this->session->userdata('type') == "0" || $this->session->userdata('type') == "2" || $this->session->userdata('type') == "9" || $this->session->userdata('type') == "14" || $this->session->userdata('type') == "1" || ($this->session->userdata('type') == "11" && $this->session->userdata('code_wilayah') == "" && $this->session->userdata('code_bk_hkk') == "")  || $this->session->userdata('type') == "12" || $this->session->userdata('type') == "13") echo isset($val->attachment) ? '<a target="_blank" href="' . base_url() . 'assets/uploads/' . $val->attachment . '">' . $val->attachment . '</a>' : ''; ?></label> </td>
                    </tr>
                  <?php
                    $i++;
                  }
              ...
              <table class="table" style="margin-left:5px;">
                ...
                ?>
                  ...
                  <tr class="row">
                    ...
                    <td><label class="control-label"><?php echo isset($val->description) ? $val->description : ''; ?></label> </td>
                    <td><label class="control-label"><?php echo isset($val->attachment) ? '<a target="_blank" href="' . base_url() . 'assets/uploads/' . $val->attachment . '">' . $val->attachment . '</a>' : ''; ?></label> </td>
                  </tr>
                <?php
                  $i++;
                }
