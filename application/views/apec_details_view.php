      ...
      <div class="card mb-4 bg-light">
        <div class="card-header bg-light">
          <div class="d-flex justify-content-between align-items-center">
            <h3><?= $detail_apec['nama'] ?></h3>
            <p class="text-muted">Member Since: <?= date('d/m/Y', strtotime($detail_apec['created'])) ?></p>
          </div>
        </div>
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-center mb-3">
            <img class="img-thumbnail" width="250"
              src="<?= base_url('assets/uploads/') . $detail_apec['photo'] ?>"
              alt="">
          </div>
            ...
            <div class="card-body">
              ...
              <?php foreach ($profileFields as $label => $key): ?>
                <div class="row mb-2">
                  ...
                  <div class="col-8">
                    <p class="mb-0">
                      <?= is_callable($key) ? $key($detail_apec) : ($detail_apec[$key] ?? '-') ?>
                    </p>
                  </div>
                </div>
              <?php endforeach; ?>
          ...
          <div class="card mb-3 shadow">
            <div class="card-body">
              <h5>Phone</h5>
              <hr>
              <?php foreach ($detail_apec['addresses'] as $contact): ?>
                <p><?= $contact['phone'] ?></p>
              <?php endforeach; ?>
              <h5>Email</h5>
              <hr>
          ...
          <div class="card mb-3 shadow">
            <div class="card-body">
              ...
              <table class="table table-borderless">
                <tbody>
                  <?php if (!empty($detail_apec['addresses'])): ?>
                    <?php foreach ($detail_apec['addresses'] as $addr): ?>
                      <tr>
          ...
          <div class="card mb-3">
            <div class="card-body">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php if (!empty($detail_apec['experiences'])): ?>
                    <?php foreach ($detail_apec['experiences'] as $exp): ?>
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  if (!empty($detail_apec['educations'])): ?>
                    <?php foreach ($detail_apec['educations'] as $edu): ?>
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  if (!empty($detail_apec['certifications'])): ?>
                    <?php foreach ($detail_apec['certifications'] as $cert): ?>
