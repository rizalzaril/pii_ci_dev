...
class Aer_model extends CI_Model
{

  public function get_aer($start, $length, $order_col = null, $order_dir = null, $start_date = null, $end_date = null)
  {
    $this->db->select('*');
    $this->db->from('aer');
