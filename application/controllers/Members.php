...
<p>
Kepada Yth,<br />
PS PPI â€“ UNIVERSITAS GADJAH MADA<br />
Di <br />
Tempat
</p>
<br />
...
Bersama ini kami sampaikan Informasi Pembayaran <b>$pay_for</b> peserta PSPPI â€“ Universitas Gadjah Mada, atas nama : $nama sebesar : <b>Rp. $rp,-</b> (Terbilang : $terbilang ) <br /><br />
...
Bersama ini kami sampaikan pemberitahuan kewajiban pembayaran <b>$pay_for</b> peserta PSPPI â€“ Universitas Gadjah Mada sebesar : <b>Rp. $rp,-</b> (<i>$terbilang</i>).<br /><br />
...
EOD;
  ...
  public function skip_file($filename = '')
  {
    ...
    if (!in_array($type, $akses)) {
      ...
      show_404('Mohon maaf, anda tidak memiliki hak untuk mengakses file ini');
    } else {
